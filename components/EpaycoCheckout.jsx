          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-yellow-700 dark:text-yellow-300 text-xs mt-1">
                Estamos realizando ajustes en nuestro sistema de pagos para
                mejorar tu experiencia. Por favor, contáctanos por WhatsApp para
                procesar tu pedido manualmente.
              </p>
              <div className="mt-3">
                <a
