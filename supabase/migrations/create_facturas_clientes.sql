...
CREATE TABLE IF NOT EXISTS clientes (
  ...
  descuento_fidelidad INTEGER DEFAULT 0, -- Porcentaje de descuento (0-100)
  nivel_fidelidad VARCHAR(20) DEFAULT 'bronce', -- bronce, plata, oro, platino
...
CREATE TABLE IF NOT EXISTS facturas (
  ...
  -- Información del cliente (snapshot al momento de la factura)
...
-- Función para actualizar estadísticas de cliente después de crear factura
...
BEGIN
  IF NEW.cliente_id IS NOT NULL THEN
    ...
    SET
      ...
      -- Actualizar nivel de fidelidad según total gastado
      nivel_fidelidad = CASE
        ...
        ELSE 'bronce'
      END,
      -- Actualizar descuento según nivel
...
-- Permitir acceso público (ajusta según tus necesidades de seguridad)
ALTER TABLE clientes ENABLE ROW LEVEL SECURITY;
ALTER TABLE facturas ENABLE ROW LEVEL SECURITY;

-- Políticas básicas (todos pueden leer y escribir - ajusta según necesites)
