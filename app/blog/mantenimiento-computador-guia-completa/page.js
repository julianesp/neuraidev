...
export const metadata = {
  ...
  keywords:
    "mantenimiento computador, limpiar PC, optimizar computador, mantenimiento preventivo, Colombia",
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 dark:text-gray-300">
          <p className="text-xl mb-6">
            Un computador bien mantenido puede durar muchos años funcionando
            perfectamente. En esta guía completa, aprenderás todo sobre
            mantenimiento preventivo y correctivo para mantener tu PC en óptimas
            condiciones.
          </p>
          ...
          <p className="mb-4">
            La acumulación de polvo es el enemigo número uno de tu PC:
          </p>
          ...
          <ol className="list-decimal pl-6 mb-6 space-y-3">
            <li>
              <strong>Apaga y desconecta completamente el computador</strong>
            </li>
            <li>
              <strong>Abre la carcasa:</strong> Retira los tornillos del panel
              lateral
            </li>
            <li>
              <strong>Limpia el polvo:</strong> Usa aire comprimido en
              ventiladores, disipadores y ranuras
            </li>
            <li>
              <strong>Limpia los ventiladores:</strong> Usa una brocha para las
              aspas
            </li>
            <li>
              <strong>Revisa los filtros:</strong> Limpialos o reemplázalos si
              están muy sucios
            </li>
            <li>
              <strong>Limpia la RAM y slots:</strong> Retira y limpia los
              contactos con alcohol isopropílico
            </li>
            <li>
              <strong>Verifica conexiones:</strong> Asegúrate de que todos los
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 p-6 rounded mb-8">
            ...
            <ul className="list-disc pl-6 text-yellow-800 dark:text-yellow-200 space-y-1">
              <li>
                No uses aspiradora directamente en componentes (genera estática)
              </li>
              <li>Mantén el aire comprimido en posición vertical</li>
              <li>No toques componentes sin pulsera antiestática</li>
              <li>
                No uses líquidos en componentes electrónicos (excepto alcohol
                isopropílico en contactos)
              </li>
            </ul>
          </div>
          ...
          <p className="mb-4">
            La pasta térmica se seca con el tiempo, reduciendo la transferencia
            de calor entre el procesador y el disipador. Debería cambiarse cada
            1-2 años:
          </p>
          <ol className="list-decimal pl-6 mb-6 space-y-2">
            <li>
              Retira el disipador del CPU (consulta el manual si es necesario)
            </li>
            <li>
              Limpia la pasta vieja con alcohol isopropílico y paño de
              microfibra
            </li>
            <li>
              Aplica una pequeña cantidad de pasta nueva (tamaño de un grano de
              arroz)
            </li>
            <li>
              Reinstala el disipador asegurándote de que quede bien sujeto
            </li>
          </ol>
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            <li>
              <strong>Limpieza de disco:</strong> Elimina archivos temporales y
              basura
            </li>
            <li>
              <strong>Desfragmentación:</strong> Solo para discos HDD (no SSD)
            </li>
            <li>
              <strong>Actualizaciones:</strong> Mantén Windows y drivers
              actualizados
            </li>
            <li>
              <strong>Programas de inicio:</strong> Desactiva aplicaciones
              innecesarias que inician con Windows
            </li>
            <li>
              <strong>Antivirus:</strong> Escaneo completo mensual
            </li>
          </ul>
          ...
          <ol className="list-decimal pl-6 mb-8 space-y-2">
            <li>
              Libera espacio en disco (elimina archivos innecesarios, desinstala
              programas)
            </li>
            <li>
              Adquiere un disco sólido o SSD (la mejora más notable que puedes
              hacer)
            </li>
          ...
          <p className="mb-4">
            <strong>Síntomas:</strong> Apagones repentinos, ventiladores
            ruidosos, rendimiento reducido
          </p>
          ...
          <p className="mb-4">
            <strong>Tipos de ruido y causas:</strong>
          </p>
          <ul className="list-disc pl-6 mb-8 space-y-2">
            <li>
              <strong>Zumbido continuo:</strong> Ventiladores sucios o
              desgastados
            </li>
            <li>
              <strong>Clic repetitivo:</strong> Disco duro HDD dañado (respalda
              datos inmediatamente)
            </li>
            <li>
              <strong>Chirrido agudo:</strong> Ventilador del CPU o fuente de
              poder fallando
            </li>
            <li>
              <strong>Vibración:</strong> Tornillos flojos o componentes mal
              montados
            </li>
          </ul>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-6 rounded-lg mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-1">
              ...
              <li>
                Formateo y reinstalación del sistema (opcional pero recomendado)
              </li>
              <li>
                Evaluación de upgrades o de actualizaciones (RAM, SSD, etc.)
              </li>
            </ul>
          </div>

          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mt-12 mb-4">
            Actualizaciones recomendados para mejorar rendimiento
          </h2>
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg">
              ...
              <p className="text-green-800 dark:text-green-200 mb-2">
                Reemplazar un HDD por un SSD puede hacer que tu PC parezca
                nueva. Beneficios:
              </p>
              <ul className="list-disc pl-6 text-green-700 dark:text-green-300 space-y-1">
                <li>
                  Windows arranca en 10-15 segundos (vs 1-2 minutos con HDD)
                </li>
              ...
              <p className="mt-3 text-green-800 dark:text-green-200">
                <strong>Costo en Colombia:</strong> Desde $140.000 (256GB) - En
                neurai.dev tenemos SSD de calidad
              </p>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg">
              ...
              <p className="text-blue-800 dark:text-blue-200 mb-2">
                Si tu PC tiene 4GB o menos, adquiere una RAM de 8GB o más, según
                lo que tu computadora permita y mejorará drásticamente el
                rendimiento:
              </p>
              ...
              <p className="mt-3 text-blue-800 dark:text-blue-200">
                <strong>Costo en Colombia:</strong> Desde $119.900 (8GB DDR4) -
                Tenemos Puskill DDR4 en stock
              </p>
            </div>
          </div>
          ...
          <ul className="list-disc pl-6 mb-8 space-y-2">
            <li>
              Tiene más de 7-8 años y las actualizaciones ya no son suficientes
            </li>
            <li>El procesador es muy antiguo y no soporta software moderno</li>
            <li>
              Las reparaciones cuestan más del 50% del valor de un equipo nuevo
            </li>
            <li>
              Ya no recibe actualizaciones de seguridad del sistema operativo
            </li>
            <li>
              No cumple con tus necesidades actuales incluso después de invertir
          ...
          <div className="bg-gradient-to-r from-purple-500 to-pink-600 p-8 rounded-lg text-white mt-12">
            ...
            <p className="mb-6 text-lg">
              En neurai.dev ofrecemos servicio completo de mantenimiento
              preventivo y correctivo para computadores. También vendemos
              componentes para actualizar tu computadora con: SSD, RAM, y más.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="https://wa.me/573174503604?text=Necesito servicio de mantenimiento de PC"
                target="_blank"
