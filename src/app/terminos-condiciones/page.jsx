...
export default function TerminosCondicionesPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-orange-100/30 via-yellow-50/20 to-red-100/30 dark:from-orange-900/20 dark:via-yellow-900/15 dark:to-red-900/20"></div>
      <div className="absolute inset-0 backdrop-blur-[1px] bg-white/10 dark:bg-black/10"></div>
      
      {/* Contenido */}
      <div className="max-w-4xl mx-auto bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-lg shadow-lg p-8 relative z-10">
        {/* Header */}
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <span className="font-semibold"> El cliente asume los costos de devolución.</span>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                uso.{" "}
                <span className="font-semibold">Los libros y objetos varios NO tienen garantía.</span>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-2 space-y-1">
                <p className="text-gray-700 dark:text-gray-300">📧 Email: julii1295@gmail.com</p>
                <p className="text-gray-700 dark:text-gray-300">📞 Teléfono: +57 317 450 3604</p>
                <p className="text-gray-700 dark:text-gray-300">
                  📍 Dirección: Calle 1A # 6 - 7, Colón - Putumayo
                </p>
                <p className="text-gray-700 dark:text-gray-300">🆔 NIT: 1124315657-2</p>
              </div>
            </div>
          </div>
        </section>
