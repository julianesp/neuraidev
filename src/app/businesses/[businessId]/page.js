...
// src/app/businesses/[businessId]/page.js
// ✅ VERSIÓN CORREGIDA - Con generateStaticParams para deployment
...
// // ✅ FUNCIÓN REQUERIDA PARA STATIC EXPORT
// export async function generateStaticParams() {
//   // Retorna todos los businessId posibles para pre-generar las rutas
//   return Object.keys(businessDataMap).map((businessId) => ({
...
// src/app/businesses/[businessId]/page.js
// ✅ VERSIÓN CORREGIDA - Server Component con generateStaticParams

import BusinessDetailClient from "./BusinessDetailClient";

// Lista de IDs de negocios disponibles
const availableBusinessIds = [
  "peluqueria-bella",
  "supermercado-local",
  // Agrega aquí más IDs cuando tengas más negocios
];

// ✅ FUNCIÓN DEL SERVIDOR para generateStaticParams
export async function generateStaticParams() {
  return availableBusinessIds.map((businessId) => ({
    businessId: businessId,
  }));
}

// ✅ SERVER COMPONENT que pasa props al client component
// export default async function BusinessDetailPage({ params }) {
//   return <BusinessDetailClient businessId={params.businessId} />;
// }
