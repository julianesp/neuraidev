      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Tu tienda especializada en accesorios tecnológicos, libros y productos de calidad.
        ...
        <div className="mt-16 bg-gradient-to-r from-primary/10 to-secondary/10 dark:from-primary/20 dark:to-secondary/20 rounded-2xl p-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Contáctanos y te ayudaremos a encontrar el accesorio perfecto para ti.
            También ofrecemos servicios técnicos especializados.
          </p>
        ...
        <div className="mt-12 bg-white/20 dark:bg-black/20 backdrop-blur-md rounded-2xl p-6 border border-white/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div className="flex flex-col items-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white">Horarios</h4>
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white">Modalidad</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Atención Virtual<br />
                y Domicilios
              </p>
