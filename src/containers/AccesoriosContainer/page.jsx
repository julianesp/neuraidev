...
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
//         {/* Carrusel principal - SECCIÓN CORREGIDA */}
...
//             {/* Controles del carrusel de relacionados - solo si hay más de 4 en desktop o 2 en móvil */}
//             {((otrosAccesorios.length > 4 && window.innerWidth >= 768) ||
//               (otrosAccesorios.length > 2 && window.innerWidth < 768)) && (
//               <>
//                 <button
//                   onClick={prevRelatedSlide}
//                   className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-4 bg-white p-2 rounded-full shadow-md hover:bg-gray-50 transition-all"
