...
// import Image from "next/image";import styles from "../styles/components/Footer.module.scss";
...
//       <article className={styles.information}>
//         <h2 className="font-bold underline text-xl text-white bg-w">
//           Ubicación
//         </h2>
...
//         <h3>
//           <Link href="/TerminosCondiciones" className="text-white">
