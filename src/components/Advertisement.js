        ...
        <AnimatePresence>
          {isVisible && (
            ...
            <motion.div
              ...
              className={`${styles.motion} fixed bottom-4 left-1/2  -translate-x-1/2 bg-white shadow-md rounded-lg overflow-hidden max-w-sm w-52 sm:relative sm:translate-x-0 rounded-b-sm `}
            >
