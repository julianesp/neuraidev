...
//           <NightSkyHero style={{ maxHeight: "300px" }} />
//         </div>

//         {/* Sección de publicidad principal */}
...
//         <section
//           ref={linkDirectRef}
//           className={`${styles.linksDirect} ${styles.fadeInUp}`}
//         >
//           <a
//             href="#services"
//             onClick={(e) => {
...
//         {/* Sección de publicidad lateral */}
//         <section ref={publicidadRef} className={`${styles.publicidad}`}>
//           <Advertisement ads={ads} />
//         </section>

//         {/* Botón para mostrar/ocultar aside/negocios */}
//         <div className="fixed right-4 bottom-24 z-50">
//           <button
//             className="bg-gray-800 text-white rounded-full p-3 shadow-lg hover:bg-gray-700 transition-all"
//             onClick={() => {
//               // Lógica para mostrar/ocultar el aside
//               const aside = document.querySelector(
//                 `.${styles.publicidad}:nth-child(n+6)`,
//               );
//               if (aside) {
