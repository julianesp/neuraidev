...
//   // Referencias para los elementos con animación
...
//         {/* Sección de presentación con efecto parallax */}
//         <ParallaxSection
//           className={`${styles.presentation}`}
//           bgImage={presentationImages[0] || imagePath[0]}
//           height="500px"
//           speed={0.3}
//         >
//           <div className="w-full bg-opacity-70 bg-black p-4">
//             <CarouselDemo apiUrl={API_CELULARES} />
//           </div>
//         </ParallaxSection>
...
// import AccesoriosBase from "@/components/Accesorio/AccesoriosBase";
// import AccesoriosDestacados from "@/components/Accesorio/AccesoriosDestacados";
// import ParallaxSection from "@/components/ParallaxSection"; // Importamos el componente de parallax
...
//         className={`${styles.container} bg-white text-black dark:bg-gray-800 dark:text-white`}
//       >
//         {/* Sección de presentación con Parallax */}
//         <ParallaxSection
//           bgImage={presentationImages[0] || imagePath[0]}
//           height="400px"
//           speed={0.3}
...
//         {/* Sección de accesorios con Parallax */}
//         <ParallaxSection
//           bgImage={imagePath[0]}
//           height="auto"
//           speed={0.4}
...
//                 <Link
//                   href={`/ProductoDetalle?id=${CATEGORIA_IDS.COMPUTADORES}`}
//                 >
//                   Ver más
//                 </Link>
//               </article>
...
//                 />
//                 <Link
//                   href={`/ProductoDetalle?id=${CATEGORIA_IDS.LIBROS_NUEVOS}`}
//                 >
//                   Ver más
//                 </Link>
//               </article>
...
//                 />
//                 <Link
//                   href={`/ProductoDetalle?id=${CATEGORIA_IDS.LIBROS_USADOS}`}
//                 >
//                   Ver más
//                 </Link>
//               </article>
...
//         {/* Enlaces directos con animación fadeIn */}
//         <section
//           ref={linkDirectRef}
//           className={`${styles.linksDirect} ${styles.fadeInUp} w-full h-12 flex items-center justify-center mb-6`}
//         >
//           <a
//             href="#services"
//             onClick={(e) => {
...
//         {/* Sección de publicidad con animación fadeIn */}
//         <section
//           ref={publicidadRef}
//           className={`${styles.publicidad} ${styles.fadeInUp}`}
//         >
//           <Advertisement ads={ads} />
//         </section>
...
import AccesoriosDestacados from "@/components/Accesorio/AccesoriosDestacados";
import ParallaxSection from "@/components/ParallaxSection"; // Importamos el componente de parallax
import NightSkyHero from "@/components/NightSkyHero"; // Importamos el componente de héroe nocturno
  ...
  return (
    <>
      ...
      >
        ...
        {/* Sección de publicidad con animación fadeIn 
            se utiliza esto: ${styles.fadeInUp}
        */}

        <section ref={publicidadRef} className={`${styles.publicidad}`}>
          {/* <Advertisement ads={ads} /> */}
        </section>
