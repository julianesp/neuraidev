...
import { Code, Smartphone, Zap, Search, ShoppingCart, Palette, MessageCircle } from "lucide-react";
  ...
  const servicios = [
    {
      ...
      descripcion: "Sitios web modernos, rápidos y optimizados para SEO",
      color: "#667eea"
    },
    {
    ...
    },
    {
      ...
      descripcion: "E-commerce completo con pasarelas de pago integradas",
      color: "#4facfe"
    },
    {
      icon: <Search size={40} />,
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p>
            ...
            Desde landing pages hasta tiendas online completas.
          </p>
        </div>
          ...
          {servicios.map((servicio, index) => (
            <div key={index} className={styles.serviceCard}>
              <div
                ...
                style={{ background: `linear-gradient(135deg, ${servicio.color}, ${servicio.color}dd)` }}
              >
                {servicio.icon}
              </div>
