...
const NightSkyHero = () => {
  ...
  return (
    <section
      ref={heroSectionRef}
      className={`-top-20 nightSky-container`}
      style={{
        position: "relative",
        width: "100vw",
        height: "100vh",
    ...
    >
      <div
        ...
        style={{
          ...
          width: "100%",
          height: "100%",
          // Reemplaza con tu imagen de un campo nocturno
          //   backgroundImage: "url('/images/night-field.jpg')",
          backgroundImage:
      ...
      <div
        className="nightSky-content top-8"
        style={{
          position: "relative",
          zIndex: 10,
          color: "white",
