  ...
  const servicesData = [
    {
      ...
      description: "Formateo completo con instalación de Windows/Linux, programas esenciales y optimización del sistema para máximo rendimiento.",
      image: "https://0dwas2ied3dcs14f.public.blob.vercel-storage.com/servicios/mantenimiento.jpg",
      features: ["Instalación de Sistema Operativo", "Programas Básicos", "Drivers Actualizados", "Antivirus Configurado"],
      price: "Desde $80.000",
      icon: "💻"
    },
    {
      ...
      description: "Limpieza completa interna y externa, cambio de pasta térmica, optimización del sistema y diagnóstico de hardware.",
      image: "https://0dwas2ied3dcs14f.public.blob.vercel-storage.com/servicios/mantenimiento.jpg",
      features: ["Limpieza Interna", "Cambio Pasta Térmica", "Optimización Sistema", "Diagnóstico Hardware"],
      price: "Desde $50.000",
      icon: "🔧"
    },
    {
      ...
      description: "Mejora tu PC con nuevos componentes: RAM DDR4, discos SSD, y más. Instalación incluida con garantía.",
      image: "https://0dwas2ied3dcs14f.public.blob.vercel-storage.com/servicios/mantenimiento.jpg",
      features: ["Memoria RAM DDR4", "Discos SSD mSATA", "Hub USB C", "Instalación Incluida"],
      price: "Desde $63.900",
      icon: "⚡"
    },
    {
      ...
      description: "Asesoría personalizada, soporte remoto y presencial, configuración de redes y recuperación de datos.",
      image: "https://0dwas2ied3dcs14f.public.blob.vercel-storage.com/servicios/mantenimiento.jpg",
      features: ["Soporte Remoto", "Configuración Redes", "Recuperación Datos", "Asesoría Especializada"],
      price: "Desde $40.000",
      icon: "🛠️"
    }
  ];
    ...
    <div className="w-full max-w-6xl mx-auto my-8 px-4">
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          Soluciones completas para mantener tu computador en óptimas condiciones
        </p>
      </div>
          ...
          <div className="relative overflow-hidden flex items-center justify-center">
            ...
            <Image
              ...
              onError={(e) => {
                ...
                e.target.src = "https://0dwas2ied3dcs14f.public.blob.vercel-storage.com/servicios/mantenimiento.jpg";
              }}
            />
