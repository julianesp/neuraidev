    ...
    <RootLayout>
      <div className={styles.policyContainer}>
        ...
        <div className={styles.policySectionsGrid}>
          <section
            className={`${styles.policySection} ${styles.fullWidthSection}`}
          >
            <h2>Introducción</h2>
            <p>
          ...
          <section className={styles.policySection}>
            ...
            <ul>
              ...
              <li>
                Enviar información sobre promociones (solo con su
                consentimiento)
              </li>
            </ul>
          </section>
          ...
          <section className={styles.policySection}>
            ...
            <ul>
              <li>
                Acceso restringido a la información por parte de nuestro
                personal
              </li>
          ...
          <section
            className={`${styles.contactSection} ${styles.fullWidthSection}`}
          >
            <h2>Contacto</h2>
            <p>
